...
const NavBar = () => {
  ...
  return (
    ...
    <nav className="flex justify-between w-full border-b-2 drop-shadow-md pb-4">
    ...
    <nav className={menu ? "bg-white border-r-2 fixed h-full top-0 w-[60%] ease-in-out duration-200" : "fixed left-[-100%]" }>
